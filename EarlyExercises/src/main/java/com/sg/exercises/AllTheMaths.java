...
public class AllTheMaths {
    public static void main(String[] args) {
        ...
        System.out.println(5565.0 / 22.0); // 252
        System.out.print("223 times 32 -42: ");
        System.out.println("223 * 32 - 42");
        System.out.print("Is 4 greater than -1? ");
        System.out.println(4 > -1);
        
        System.out.println("\n****** Now to make the computer do some harder maths!");
        System.out.print("8043.52 minus 4.2 plus 23.0 divided by 56.0 times -76.13 is: ");
        System.out.println(8043.52 - 4.2 + 23.0 / 56.0 * -76.13); // 8039
        ...
        System.out.println(44 - 22 - 11 - 88 - 76 - 11 - 33);
